...
export default class iPhoneSEBox extends React.Component {
          ...
          <View
            ...
            <View
              ...
              <Image
                ...
                source={require('./iPhoneSE/iPhoneSE-box-earpods.jpeg')}>
              </Image>
            </View>
            <Text
            ...
            <View
              ...
              <Image
                style={{ width: 225, height: 280, resizeMode: 'contain' }}
                source={require('./iPhoneSE/iPhoneSE-box-iphonese.jpeg')}>
              </Image>
            </View>
            <Text
              style={{ fontFamily: 'System', fontSize: 16, marginTop: 40 }}>iPhone SE</Text>
            <View
              style={{ marginTop: 40, marginHorizontal: 20, paddingHorizontal: 40, alignItems: 'center', backgroundColor: '#F9FAFB' }}>
              <Image
                style={{ width: 225, height: 280, resizeMode: 'contain' }}
                source={require('./iPhoneSE/iPhoneSE-box-power.jpeg')}>
              </Image>
            </View>
            <Text
            ...
            <View
              ...
              <Image
                style={{ width: 225, height: 280, resizeMode: 'contain' }}
                source={require('./iPhoneSE/iPhoneSE-box-lightning.jpeg')}>
              </Image>
            </View>
            <Text
