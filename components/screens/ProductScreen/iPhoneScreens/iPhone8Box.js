...
export default class iPhone8Box extends React.Component {
          ...
          <View
            ...
            <View
              ...
              <Image
                ...
                source={require('./iPhone8/iPhone8-box-earpods.jpeg')}>
              </Image>
            </View>
            <Text
            ...
            <View
              ...
              <Image
                style={{ width: 225, height: 280, resizeMode: 'contain' }}
                source={require('./iPhone8/iPhone8-box-iphone8.jpeg')}>
              </Image>
            </View>
            <Text
              style={{ fontFamily: 'System', fontSize: 16, marginTop: 40 }}>iPhone 8</Text>
            <View
              style={{ marginTop: 40, marginHorizontal: 20, paddingHorizontal: 40, alignItems: 'center', backgroundColor: '#F9FAFB' }}>
              <Image
                style={{ width: 225, height: 280, resizeMode: 'contain' }}
                source={require('./iPhone8/iPhone8-box-lightning.jpeg')}>
              </Image>
            </View>
            <Text
            ...
            <View
              ...
              <Image
                style={{ width: 225, height: 280, resizeMode: 'contain' }}
                source={require('./iPhone8/iPhone8-box-power.jpeg')}>
              </Image>
            </View>
            <Text
            ...
            <View
              ...
              <Image
                style={{ width: 225, height: 280, resizeMode: 'contain' }}
                source={require('./iPhone8/iPhone8-box-headphone.jpeg')}>
              </Image>
            </View>
            <View
