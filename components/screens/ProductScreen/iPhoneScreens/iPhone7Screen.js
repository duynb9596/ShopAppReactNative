...
export default class iPhone7Screen extends React.Component {
  ...
  _loadData()
  {
    firebaseApp.database().ref('shopapp/list_ProductType/iPhone/product/iPhone 7/').once('value', (product) => {
      console.log(product)
      this.setState({
    ...
    firebaseApp.database().ref('shopapp/list_ProductType/iPhone/product/iPhone 7/price/').once('value', (price) => {
      this.setState({
        fromprice: parseInt(price.val())
      })
    })
    var model = []
    firebaseApp.database().ref('shopapp/list_ProductType/iPhone/product/iPhone 7/model/').once('value', (childModelSnapshot) => {
      ...
      firebaseApp.database().ref('shopapp/list_ProductType/iPhone/product/iPhone 7/model/' + this.state.modelChooser + '/').once('value', (childmodelChooserSnapshot) => {
  ...
  _writeData()
  {
    firebaseApp.database().ref('shopapp/list_ProductType/iPhone/product/iPhone 7/model/iPhone 7/list_Finish/gold/image').set('https://firebasestorage.googleapis.com/v0/b/shopapp-8541a.appspot.com/o/iPhone%2FiPhone7-gold.png?alt=media&token=4cdfc1b3-08d5-45fb-8b82-e064d31e78f8')
    firebaseApp.database().ref('shopapp/list_ProductType/iPhone/product/iPhone 7/model/iPhone 7/list_Finish/rosegold/image').set('https://firebasestorage.googleapis.com/v0/b/shopapp-8541a.appspot.com/o/iPhone%2FiPhone7-rosegold.png?alt=media&token=c20d9456-78c0-491d-b279-ecb0417e95e6')
    firebaseApp.database().ref('shopapp/list_ProductType/iPhone/product/iPhone 7/model/iPhone 7/list_Finish/jet/image').set('https://firebasestorage.googleapis.com/v0/b/shopapp-8541a.appspot.com/o/iPhone%2FiPhone7-jetblack.png?alt=media&token=2c91cf70-9175-45eb-b9be-1a07246556df')
    firebaseApp.database().ref('shopapp/list_ProductType/iPhone/product/iPhone 7/model/iPhone 7/list_Finish/black/image').set('https://firebasestorage.googleapis.com/v0/b/shopapp-8541a.appspot.com/o/iPhone%2FiPhone7-black.png?alt=media&token=810af127-63e7-4be4-8190-e50b96b9c9e7')
    firebaseApp.database().ref('shopapp/list_ProductType/iPhone/product/iPhone 7/model/iPhone 7/list_Finish/silver/image').set('https://firebasestorage.googleapis.com/v0/b/shopapp-8541a.appspot.com/o/iPhone%2FiPhone7-silver.png?alt=media&token=35679d79-16ac-4cb9-9121-5c16ef5fb02d')
    firebaseApp.database().ref('shopapp/list_ProductType/iPhone/product/iPhone 7/model/iPhone 7 Plus/list_Finish/gold/image').set('https://firebasestorage.googleapis.com/v0/b/shopapp-8541a.appspot.com/o/iPhone%2FiPhone7Plus-gold.png?alt=media&token=fd05d1ad-a8b5-4361-bdcd-766de5ac10d7')
    firebaseApp.database().ref('shopapp/list_ProductType/iPhone/product/iPhone 7/model/iPhone 7 Plus/list_Finish/rosegold/image').set('https://firebasestorage.googleapis.com/v0/b/shopapp-8541a.appspot.com/o/iPhone%2FiPhone7Plus-rosegold.png?alt=media&token=387ab7d6-339d-43f2-b27b-fdacddf7b4db')
    firebaseApp.database().ref('shopapp/list_ProductType/iPhone/product/iPhone 7/model/iPhone 7 Plus/list_Finish/jet/image').set('https://firebasestorage.googleapis.com/v0/b/shopapp-8541a.appspot.com/o/iPhone%2FiPhone7Plus-jetblack.png?alt=media&token=e11976f7-1505-4262-ae4e-83fedf75a001')
    firebaseApp.database().ref('shopapp/list_ProductType/iPhone/product/iPhone 7/model/iPhone 7 Plus/list_Finish/black/image').set('https://firebasestorage.googleapis.com/v0/b/shopapp-8541a.appspot.com/o/iPhone%2FiPhone7Plus-black.png?alt=media&token=666a5534-3bf1-4c0d-9ce3-d5e7eec14c3f')
    firebaseApp.database().ref('shopapp/list_ProductType/iPhone/product/iPhone 7/model/iPhone 7 Plus/list_Finish/silver/image').set('https://firebasestorage.googleapis.com/v0/b/shopapp-8541a.appspot.com/o/iPhone%2FiPhone7Plus-silver.png?alt=media&token=4b206aee-d6e6-4184-bafb-ce19bbf0d960')
  }
  ...
  {
    firebaseApp.database().ref('shopapp/list_ProductType/iPhone/product/iPhone 7/model/' + model.key + '/').once('value', (childmodelChooserSnapshot) => {
      this.setState({
  ...
  _onPress_Gallery()
  {
    this.props.navigation.navigate("iPhone7Gallery", {
      title: "Gallery"
    })
  }
  ...
  _onPress_Box()
  {
    this.props.navigation.navigate("iPhone7Box")
  }
      ...
      <SafeAreaView
        ...
        <ScrollView
          ...
          <View
            ...
            <Text
              style={{paddingTop: 20, paddingBottom: 10, fontFamily: 'System', fontSize: 32, marginTop: 20}}>Choose your iPhone 7</Text>
            <Text
