...
export default class iPhoneXBox extends React.Component {
          ...
          <View
            ...
            <View
              ...
              <Image
                ...
                source={require('./iPhoneX/iPhoneX-box-earpods.jpeg')}>
              </Image>
            </View>
            <Text
            ...
            <View
              ...
              <Image
                style={{ width: 225, height: 280, resizeMode: 'contain' }}
                source={require('./iPhoneX/iPhoneX-box-iphonex.jpeg')}>
              </Image>
            </View>
            <Text
              style={{ fontFamily: 'System', fontSize: 16, marginTop: 40 }}>iPhone X</Text>
            <View
              style={{ marginTop: 40, marginHorizontal: 20, paddingHorizontal: 40, alignItems: 'center', backgroundColor: '#F9FAFB' }}>
              <Image
                style={{ width: 225, height: 280, resizeMode: 'contain' }}
                source={require('./iPhoneX/iPhoneX-box-lightning.jpeg')}>
              </Image>
            </View>
            <Text
            ...
            <View
              ...
              <Image
                style={{ width: 225, height: 280, resizeMode: 'contain' }}
                source={require('./iPhoneX/iPhoneX-box-power.jpeg')}>
              </Image>
            </View>
            <Text
            ...
            <View
              ...
              <Image
                style={{ width: 225, height: 280, resizeMode: 'contain' }}
                source={require('./iPhoneX/iPhoneX-box-headphone.jpeg')}>
              </Image>
            </View>
            <View
