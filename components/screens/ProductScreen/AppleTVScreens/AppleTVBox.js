...
export default class AppleTVBox extends React.Component {
          ...
          <View
            ...
            <View
              ...
              <Image
                ...
                source={require('./AppleTV/AppleTV-box-appletv.jpeg')}>
              </Image>
            </View>
            <Text
              style={{ fontFamily: 'System', fontSize: 16, marginTop: 40 }}>Apple TV</Text>
            <View
              style={{ marginTop: 40, marginHorizontal: 20, paddingHorizontal: 40, alignItems: 'center', backgroundColor: '#F9FAFB'}}>
              <Image
                style={{ width: 225, height: 280, resizeMode: 'contain' }}
                source={require('./AppleTV/AppleTV-box-remote.jpeg')}>
              </Image>
            </View>
            <Text
            ...
            <View
              ...
              <Image
                style={{ width: 225, height: 280, resizeMode: 'contain' }}
                source={require('./AppleTV/AppleTV-box-power.jpeg')}>
              </Image>
            </View>
            <Text
            ...
            <View
              ...
              <Image
                style={{ width: 225, height: 280, resizeMode: 'contain' }}
                source={require('./AppleTV/AppleTV-box-lightning.jpeg')}>
              </Image>
            </View>
            <Text
