...
const listGallery = [
    require('./AppleTV4K/AppleTV4K-gallery1.jpg'),
    require('./AppleTV4K/AppleTV4K-gallery2.jpg'),
    require('./AppleTV4K/AppleTV4K-gallery3.jpg'),
]

export default class AppleTV4KGallery extends React.Component {
