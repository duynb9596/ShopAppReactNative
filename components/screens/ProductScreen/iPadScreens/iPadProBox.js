...
export default class iPadProBox extends React.Component {
          ...
          <View
            ...
            <View
              ...
              <Image
                ...
                source={require('./iPadPro/iPadPro-box-ipadpro.jpeg')}>
              </Image>
            </View>
            <Text
              style={{ fontFamily: 'System', fontSize: 16, marginTop: 40 }}>iPad Pro</Text>
            <View
              style={{ marginTop: 40, marginHorizontal: 20, paddingHorizontal: 40, alignItems: 'center', backgroundColor: '#F9FAFB' }}>
              <Image
                style={{ width: 225, height: 280, resizeMode: 'contain' }}
                source={require('./iPadPro/iPadPro-box-lightening.jpeg')}>
              </Image>
            </View>
            <Text
            ...
            <View
              ...
              <Image
                style={{ width: 225, height: 280, resizeMode: 'contain' }}
                source={require('./iPadPro/iPadPro-box-power.jpeg')}>
              </Image>
            </View>
            <Text
